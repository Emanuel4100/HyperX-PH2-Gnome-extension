...
const HID_REQUEST_BYTES = Uint8Array.of(0x50, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00); // 64 bytes
const UPDATE_INTERVAL_SECONDS = 30;
// ---- Helper functions to talk to hidraw in pure GJS ----
function findHyperxHidIndex() {
    try {
...
function readHyperxBatteryPercent() {
    ...
    try {
        ...
        const arr = responseBytes.toArray();
        if (arr.length === 0) {
